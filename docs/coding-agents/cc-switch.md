...
<div class="zzm-img-placeholder">📷 CC Switch 主界面概览</div>
...
<div class="zzm-img-placeholder">📷 CC Switch 下载页面</div>
...
<div class="zzm-img-placeholder">📷 CC Switch Codex 配置界面</div>
...
<div class="zzm-img-placeholder">📷 CC Switch Claude Code 配置界面</div>
...
<div class="zzm-img-placeholder">📷 CC Switch 启用 Provider 的状态</div>
