...
![Cherry Studio 主界面](/screenshots/cherry-studio-main.png)
...
![Cherry Studio 新增服务商配置页面](/screenshots/cherry-studio-provider-config.png)
...
![Cherry Studio 对话成功效果](/screenshots/cherry-studio-chat-success.png)
